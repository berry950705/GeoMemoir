(function(){
        ...
        $('#submit_btn').click(function(){
                if(story_title.val() &&get_checkArea()&&get_checkCateg()&&countries.val()&&photoDesc.val()&&get_Content()&&story_img[0].files[0]){
                        ...
                        $.ajax({
                                ...
                                contentType: false,
                                type: 'post',
                                url: baseUrl+ cur_lang + '/v1/stories/' + username+'/post_story',
                                data: formdata,
                                ...
                                success: function(response){
                                        if (response.code == 200){
                                                var message = newStory_messages[0][cur_lang]
                                                alert (message)
                                                setTimeout(function(){
                        ...
                        var message = newStory_messages[1][cur_lang]
                        alert(message)
                }
        })
        ...
        const newStory_messages = [
                {
                'en': 'Story has been successfully  uploaded.',
                'zh_Hant_TW': '您已成功上傳故事',
                'zh_Hans_CN': '您已成功上传故事' 
                },
                {
